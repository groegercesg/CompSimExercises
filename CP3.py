...
class Mandelbrot(object):
    def __init__(self, myIterations, myXMin, myXMax,
                 myYMin, myYMax, myFilename):
        # constructor, pulls in all relevant details to the class
        self.Iterations = myIterations
        # number of iterations of mandelbrot method
    ...
    def simulate(self):
        ...
        # enumerate - allows looping over a array,
        # and an automatic counter of it
        ...
        # plt.cm.prism - using colourmap of type prism
        # (map scalar data to colours)
        # interpolation = 'none' - have blocks of colour and
        # no artificial smoothing
        # extent - The bounding box in data coordinates that
        # the image will fill, min()/max() lowest/largest value in an item
