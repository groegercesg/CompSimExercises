...
class Polynomial(object):
    ...
    def PolyToList(self, input_list):
        ...
        for i in range(0, len(input_list)-1):
            if input_list[i] == '-':
                ...
                input_list.pop(i)
        input_list = [s for s in input_list if
    ...
    def AddPoly(self, a, b):
        # method to convert 2 polys into list form, accounting for
        # different lengths and then add them before using printPoly
        # method to output it
    ...
    def DerivePoly(self, a):
        # method to calculate the derivative of a polynomial and return
    ...
    def IntegratePoly(self, a):
        # method to calculate the indefinite integral of a polynomial
        # and return the result as a new polynomial
